        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full py-3 text-gray-300 border border-gray-600 rounded hover:bg-gray-800 transition-colors disabled:opacity-50 flex items-center justify-center space-x-2"
