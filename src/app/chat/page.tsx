                        ...
                        export default function Chat() {
                          ...
                          const FirstResponseVoiceModal = () => (
                            ...
                            >
                              <div className="flex items-center justify-center min-h-screen p-4">
                                <div 
                                  className={`bg-gray-950/95 via-black/95 to-gray-900/95 border border-gray-800/50 rounded-3xl shadow-2xl w-full max-w-md transition-all duration-300 ease-out backdrop-blur-md ${
                                  ...
                                  >
                                    <div className="px-6 md:px-10 lg:px-16 max-w-3xl mx-auto space-y-4">
                                      {messages.map((msg, index) => (
                                        <div key={index} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} animate-fadeIn`}><replit_final_file>
'use client';
                                      ...
                                      <div className="flex-1 p-3">
                                        <div className="space-y-2">
                                          ...
                                          <button 
                                            ...
                                            className="w-full flex                                              <div className="flex items-start ${msg.role === 'user' ? 'max-w-[70%]' : ''}">
                                                {msg.role === 'assistant' && (
