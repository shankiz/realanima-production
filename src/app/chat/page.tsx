...
const CharacterCard = React.memo(function CharacterCard({ character, onClick }: CharacterCardProps) {
  ...
  prev.character.description === next.character.description
                        ...
                        const PopularCharactersSection = ({ searchQuery, setSearchQuery, onSelectCharacter, filteredCharacters }: {
                          searchQuery: string;
                                  ...
                                  <div className="relative p-6">
                                    ...
                                    <div className="text-center mb-6">
                                      ...
                                      <div className="w-16 h-16 bg-gradient-to-br from-purple-500/15 to-pink-500/15 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/10">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-purple-400" fill="currentColor" viewBox="0 0 24 24">
                                          <path d="M9.5 2L8.5 6L12 7.5L15.5 6L14.5 2H9.5ZM6.5 8.5L2 9.5V14.5L6.5 15.5L7.5 12L6.5 8.5ZM17.5 8.5L16.5 12L17.5 15.5L22 14.5V9.5L17.5 8.5ZM8.5 18L9.5 22H14.5L15.5 18L12 16.5L8.5 18ZM12 10.5C11.17 10.5 10.5 11.17 10.5 12S11.17 13.5 12 13.5 13.5 12.83 13.5 12 12.83 10.5 12 10.5Z"/>
                                        </svg>
                                      </div>
                                    ...
                                    <div className="mt-8">
                                      <div className="flex items-center justify-center text-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.02 11.02 0 00-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                        </svg>
                                                  ...
                                                  <div className="space-y-2 flex-1">
                                                    {currentUserPlan === 'free' && (
                                                      <button
                                                        ...
                                                        className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white py-2.5 px-4 rounded-lg transition-all text-sm"
                                                      >
                                                        Upgrade Plan
                                                      </button>
                                                    )}
